...
function SidebarContent({ userInitial, userName, userEmail }: SidebarNavProps) {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Employee list — pinned to bottom */}
      {agents === undefined && (
        <div className="shrink-0 pt-3 border-t border-border/50 dark:border-white/[0.08]">
          <motion.div
            animate={{
              display: animate ? (open ? "block" : "none") : "block",
              opacity: animate ? (open ? 1 : 0) : 1,
          ...
          <div className="space-y-0.5">
            {[0, 1, 2].map((i) => (
              <div key={i} className={cn("flex items-center gap-2.5 rounded-xl", open ? "px-3 py-2" : "px-0 py-2 justify-center")}>
      ...
      {activeAgents.length > 0 && (
        <div className="shrink-0 pt-3 border-t border-border/50 dark:border-white/[0.08]">
          ...
          <div className="space-y-0.5 max-h-[30vh] overflow-y-auto overflow-x-hidden scrollbar-none">
              ...
              return (
                ...
                >
                  <div className="relative shrink-0">
                    <div className="h-7 w-7 rounded-lg overflow-hidden bg-muted/30 shadow-sm">
