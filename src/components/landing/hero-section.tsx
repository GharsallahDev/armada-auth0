      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          <a
            ...
            className="group relative inline-flex items-center justify-center h-10 px-5 rounded-lg text-[14px] font-medium text-white bg-indigo-600 hover:bg-indigo-500 transition-all shadow-lg shadow-indigo-500/20 hover:shadow-indigo-500/30"
          >
            Get started
