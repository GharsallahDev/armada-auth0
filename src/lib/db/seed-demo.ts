...
async function seed() {
  ...
  const [alex] = await db.insert(agents).values({
    ...
    avatarUrl: "https://api.dicebear.com/9.x/bottts/svg?seed=alex-sales&size=128&backgroundColor=transparent",
  ...
  const [jordan] = await db.insert(agents).values({
    ...
    avatarUrl: "https://api.dicebear.com/9.x/bottts-neutral/svg?seed=jordan-community&size=128&backgroundColor=transparent",
  ...
  await db.insert(agents).values({
    ...
    avatarUrl: "https://api.dicebear.com/9.x/shapes/svg?seed=atlas-research&size=128&backgroundColor=transparent",
